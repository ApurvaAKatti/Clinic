...
<head>
    ...
    <!-- Title  -->
    <title>Miracles Health Clinic</title>
...
<body>
            ...
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-12 h-100">
                        <div class="h-100 d-md-flex justify-content-between align-items-center" style="align-right">
                            <p></p>
                            <p>Opening Hours : Monday to Saturday - 10am to 9:30pm Contact : <span>123456789</span></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="hero-area">
        <!-- <div class="hero-slides owl-carousel"> -->
            <!-- Single Hero Slide -->
            <div class="single-hero-slide bg-img bg-overlay-white" style="background-image: url(img/bg-img/homeopathy-1.jpeg);">
                <div class="container h-100">
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="hero-slides-content">
                                <h2 data-animation="fadeInUp" data-delay="100ms">Miracles Health Clinic</h2>
                                <h4 data-animation="fadeInUp" data-delay="400ms">Medical Services that you can Trust 100%</h4>
                                        ...
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-12 col-md-4">
                                                <div class="form-group">
                                                    <select class="form-control" id="doctors">
	                                                    <option>Dr. Yogesh Kadam</option>
	                                                    <option>Dr. Bhagyashri Y. Kadam</option>
                                                	</select>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input data-provide="datepicker" class="form-control" name="date" id="date" placeholder="Date">
                            ...
                            <div class="col-12 col-lg-3">
                                <div class="medilife-contact-info">
                                    ...
                                    <div class="single-contact-info mb-30">
                                        ...
                                        <p>Mon - Sat 10:00am - 09:30pm <br>Sunday CLOSED</p>
                                    </div>
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info mb-30">
                                        <img src="img/icons/envelope.png" alt="">
                                        <p>123456789 <br>contact@business.com</p>
                                    </div>
                                    <!-- Single Contact Info -->
                                    <div class="single-contact-info">
                                        <img src="img/icons/map-pin.png" alt="">
                                        <p>Shop No 8 <br> Viman Palace Building<br> Viman Nagar<br> Pune - 411014</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="medica-about-content">
                        ...
                        <p>Our patients always have been and always will be our first priority!</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-service-area d-flex">
                                ...
                                <div class="service-content">
                                    ...
                                    <p>We know how important skin is! We specialise in treating skin disorders.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Single Service Area -->
                        <div class="col-12 col-sm-6">
                            <div class="single-service-area d-flex">
                                ...
                                <div class="service-content">
                                    <h5>Women Clinic</h5>
                                    <p>Curated and specialized treatment for women problems.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Single Service Area -->
                        <div class="col-12 col-sm-6">
                            <div class="single-service-area d-flex">
                                ...
                                <div class="service-content">
                                    <h5>Hair Loss</h5>
                                    <p>Let age not take away your confidence when you can now reverse your hair loss.</p>
                                </div>
                            </div>
                        </div>
                        <!-- Single Service Area -->
                        <div class="col-12 col-sm-6">
                            <div class="single-service-area d-flex">
                                ...
                                <div class="service-content">
                                    <h5>Thyroid Imbalance</h5>
                                    <p>We provide treatments for thyroid and related weightloss problems!</p>
                                </div>
                            </div>
                        </div>
                    </div>
   ...
   <!--  <div class="medilife-blog-area section-padding-100-0">
    ...
    <div class="medilife-emergency-area section-padding-100-50">
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                	<h2 style="font-size:3rem !important">For Emergency calls</h2>
                    <h3 style="font-size:3rem !important; color:white !important">+91-123456789</h3>
                </div>
                <!-- <div class="col-3"></div> -->
                <div class="col-4">
                        <div class="footer-widget-area">
                            <div class="widget-title">
                                <h6 style="color:white !important;font-size:1.2rem !important">For Queries Please drop a message and we will get back to you!</h6>
                            </div>
    ...
    <!-- ***** Footer Area Start ***** -->
    <footer class="footer-area section-padding-100" style="padding: 1em !important">
        <!-- Main Footer Area -->
